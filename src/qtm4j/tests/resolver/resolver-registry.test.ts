...
import { CommonAttributeResolver } from "../../resolver/resolvers/common-attribute-resolver";
import { ComponentResolver } from "../../resolver/resolvers/component-resolver";
import { LabelResolver } from "../../resolver/resolvers/label-resolver";
import { TestCaseUidResolver } from "../../resolver/resolvers/test-case-uid-resolver";

vi.mock("../../resolver/resolvers/common-attribute-resolver");
vi.mock("../../resolver/resolvers/label-resolver");
vi.mock("../../resolver/resolvers/component-resolver");
vi.mock("../../resolver/resolvers/test-case-uid-resolver");
