 ...
 *  10. Remove "export " from the file and then reinstate one-by-one to solve compile issues in this and `index.ts`
 *     - Only fix compile errors for types that are used in this file
 *  11.
 *
...
export const ProjectsApiFetchParamCreator = (
   ...
   * @param {string} project_id The ID of the project to retrieve the performance score for.
   * @param {string} [release_stage_name] The name of the release stage to filter the performance score.
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   */
