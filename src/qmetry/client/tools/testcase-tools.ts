...
export const TESTCASE_TOOLS: QMetryToolParams[] = [
  ...
  },
  {
    ...
    hints: [
      ...
      "⚠️ DO NOT ask user for confirmation - this is expected behavior for associated test cases",
      "",
      ...
      "",
      "⚠️ CRITICAL: INCREMENTAL tcVersion SELECTION RULE ⚠️",
      "",
      ...
      "- notrunall: false (not true) - Use this as default",
      "- notruncurrent: false (not true) - Use this as default",
      '- scope: "project" - Always use this',
      "- withVersion: true - Required for version creation",
      "",
