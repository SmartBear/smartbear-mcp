...
export const TESTCASE_TOOLS: QMetryToolParams[] = [
  ...
  },
  {
    ...
    hints: [
      ...
      "If the user explicitly asks for Test Run UDFs with these test case executions, call 'Fetch Test Run UDF Values' after this tool with sourceContext='testCaseExecutions' and sourceRows=<this response data>. Render that tool's unifiedTableRows as the final answer.",
