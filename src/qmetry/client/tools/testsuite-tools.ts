...
export const TESTSUITE_TOOLS: QMetryToolParams[] = [
  ...
  },
  {
    ...
    hints: [
      ...
      "]",
      "",
      "--- HOW TO GET list item IDs for 'list' type ---",
      "1. Use FETCH_CUSTOM_LISTS tool to find the custom list associated with the UDF field.",
      "2. Use FETCH_CUSTOM_LIST_ITEMS tool with the listId to get all items and their numeric IDs.",
      "3. Use those numeric IDs in the 'value' array of the list filter.",
      "",
