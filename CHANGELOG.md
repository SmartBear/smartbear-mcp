...
- [Swagger] Add `create_documentation_page` tool to create a markdown documentation page in a portal product in a single call. Returns page details and a `draftUrl` to edit the page in the portal admin.
